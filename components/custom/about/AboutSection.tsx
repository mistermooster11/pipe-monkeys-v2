      ...
      <div className="about__container">
        ...
        <div className="about__content">
          ...
          <h2 className="about__heading">
            Brooklyn &amp; NYC's Trusted Drain
            Cleaning Specialists
          </h2>
          <p className="about__text">
            Pipe Monkeys is a local drain cleaning and sewer service company
            serving Brooklyn, Queens, and Nassau County. We specialize in
            fast, effective solutions for clogged drains, sewer line issues,
            and camera inspections — with upfront pricing and no hidden fees.
          </p>
          <p className="about__text">
            Our licensed NYC technicians arrive prepared with the right equipment
            for every job. Every service comes with a 100% cleanup guarantee —
