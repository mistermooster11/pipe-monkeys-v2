  ...
  return (
    <footer className="footer">
      ...
      <div className="footer__top">
        <div className="footer__brand">
          ...
          <p className="footer__desc">
            <strong>Pipe Monkeys</strong> delivers same-day drain cleaning, sewer line service,
            and camera inspection for homes and businesses in Brooklyn, Queens &amp; Nassau County —
            with upfront pricing and a 100% cleanup guarantee.
          </p>
      ...
      <div className="footer__bottom">
        <p className="footer__copyright">Copyright 2025 Pipe Monkeys All rights reserved.</p>
