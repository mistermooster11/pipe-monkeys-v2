      ...
      <div className="faq__container">
        ...
        <div className="faq__left">
          ...
          <h2 className="faq__heading">
            Common Questions About Our Drain &amp; Sewer Services
          </h2>
          <p className="faq__subtext">
            Find clear answers about our drain cleaning, sewer line service, camera inspection,
            and same-day scheduling across Brooklyn, Queens &amp; Nassau County.
          </p>
